...
class CreateCatalogItem
{
    ...
    public function __invoke(
        ...
        // identity_hash is unique per printing (includes variant/finish); base_key
        // drops the variant-defining facets so every printing of the same card
        // shares one group. Both come from ItemIdentity so the repair command
