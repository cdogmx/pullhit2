 ...
 * Radiance Trainer Gallery" (child). We nest the children under their parent in
 * browse rather than listing them as sibling sets.
 */
class Subsets
{
    /** Set-name suffixes that mark a sub-set of a parent expansion. */
    public const SUFFIXES = ['Trainer Gallery', 'Galarian Gallery'];
